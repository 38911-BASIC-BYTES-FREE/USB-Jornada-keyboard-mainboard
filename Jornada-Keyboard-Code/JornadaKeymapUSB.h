...
static int keyScancode [NROWS] [NCOLS] = {
  ...
  {0,0,0,0,0,KEY_DELETE,KEY_RIGHT_ALT,0,0,0,KEY_SPACE,0,KEY_CTRL,KEY_MENU                                   },
  {0,KEY_ENTER,KEY_QUOTE,KEY_FORWARD_SLASH,0,KEY_PERIOD,KEY_COMMA,KEY_M,KEY_N,KEY_B,KEY_V,KEY_C,KEY_X,KEY_Z },
  {0,0,KEY_RIGHT,KEY_DOWN,0,KEY_LEFT,0,0,KEY_GRAVE_ACCENT,KEY_LEFT_ALT,0,0,0,0                            },
  ...
  {0,KEY_BACKSPACE,KEY_LEFT_BRACKET,KEY_P,0,KEY_O,KEY_I,KEY_U,KEY_Y,KEY_T,KEY_R,KEY_E,KEY_W,KEY_Q           }
